...
export interface ReferentialsBase {
  ID?: number;
  Title?: string;
  Category?: string;
  Order0?: number;
...
export interface ReferentialsRead extends ReferentialsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface ReferentialsWrite extends ReferentialsBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
